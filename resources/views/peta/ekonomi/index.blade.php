...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Data Ekonomi</h1>
        <h1 class="pull-right">
    ...
    <div class="content">
        ...
        @include('peta.ekonomi.choose')

        @include('peta.ekonomi.create')
            
        @include('peta.ekonomi.edit')
        
        @include('peta.ekonomi.selectpoint')
    ...
    $(function(){
        ...
        function createPoint(){
            $("#createMarker").click(function(e){
                ...
                $('#chooseCat').click(function(e){
                    e.preventDefault()
                    es = $('#selectedCat').val()
                    if (es == 'UKM dan IRT' | es == 'Warung dan Grosir'){
                        $('#createSubCat').val(es);
                        ...
                        window.location.href = '/customDatas/creates/'+'mekonomis_Data Ekonomi_'+es
                    }
        ...
        function redirectEdit(){
            window.location.href == '/customDatas/creates/'+'mekonomis_Data Ekonomi_Bencana Alam';
            return 
        }
        ...
        function editPoint(){
            ...
            $('input[id^=editMarker]').click(function(e){
                // if (e.target.attributes['data-2'].value == 'Data Ekonomi'){
                //     e.preventDefault();
                //     console.log('fds')
                //     redirectEdit();
                //     // return false
