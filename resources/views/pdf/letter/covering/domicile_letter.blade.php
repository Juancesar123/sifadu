...
<body>
	...
	<table style="font-size: 13px; width:100%;">
		<tbody>
					...
					<div style="font-size: 15px;">
						...
						<table style="padding-left: 50px; width: 100%">
							<tbody>
								...
								<tr>
									<td style="text-transform: uppercase; width: 150px">Jabatan</td>
						...
						<table style="padding-left: 50px; width: 100%">
							<tbody>
								...
								<tr>
									...
									<td>: Orang tersebut benar-benar berdomisili dan bertempat tinggal di {{$citizen->alamat}} </td>
								</tr>
								<tr>
			...
			<tr>
				<td>
					Demikian surat Keterangan Domisili ini dibuat dengan sebenarnya dan kepada pihak yang berkepentingan mohon menjadi maklum.
				</td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			<tr>
				...
				<td style="text-align:left;padding: 25px 0 25px 375px; font-size: 15px;">
					...
					<p><u>Pada tanggal : {{ date('d F Y') }}</u></p>
				</td>
			</tr>
		</tbody>
	</table>
	<table style="width: 100%">
		...
		<tbody>
			<tr style='border: 1px solid black'>
				...
				<td style="text-align:center; padding-top:0px; padding-bottom:30px;">
					<div style="font-size: 15px;">
						<p style="margin-bottom:100px;">Kepala Desa {{ $desa->profil_nama }}</p><br>
						<br>
						<br>
						<br>
						<br>
