  ...
  <table style="width:100%">
          <tbody>
              ...
              <tr style="padding-left: 30px;">
                  <td style="text-align: left;padding-bottom: 20px">
                      <div style="font-size: 15px">
                          Atas nama tersebut diatas, adalah benar <strong>Mengajuan Pembuatan SKCK</strong>  di Desa {{ env('DESA_NAME') }} Kecamatan NAGRAK Kabupaten SUKABUMI DUSUN II.
                      </div>
                  </td>
              </tr>
              <tr style="padding-left: 30px;">
                ...
                <tbody>
                  <tr>
                      <td style="text-align:left; padding-top:100px; padding-bottom:30px;">
                          <div style="font-size: 15px;">
                              <p>Karang Mulya</p>
                              <p style="margin-bottom:100px;">PEMOHON</p><br>
                              <br>
                              <br>
                              <br>
                              <br>
