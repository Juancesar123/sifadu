...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('tanggal_surat_masuk', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('tanggal_pengiriman_surat_keluar', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('agendabpds.index') !!}" class="btn btn-default">Cancel</a>
</div>
