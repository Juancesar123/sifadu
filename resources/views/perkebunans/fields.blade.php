...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('luas_area', null, ['class' => 'form-control', 'required']) !!}
</div>

<!-- Masa Pengelolaan Field -->
<div class="form-group col-sm-6">
    {!! Form::label('masa_pengelolaan', 'Masa Pengelolaan:') !!}
    {!! Form::text('masa_pengelolaan', null, ['class' => 'form-control', 'required']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('perkebunans.index') !!}" class="btn btn-default">Batalkan</a>
</div>
