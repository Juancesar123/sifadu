...
@section('content')
    ...
    <div class="content">
        ...
        @include('peta.marker.create')
            
        @include('peta.marker.edit')
        
        @include('peta.marker.selectpoint')
    ...
    $(function(){
        ...
        function selectCategory(){
            ...
            $("#createCat, #editCat").on('change', function(){
                ...
                switch (value) {
                    case 'Kesehatan':
                        var icon = 'red_clinic-medical';
                        break;
                    case 'Pendidikan':
                        var icon = 'blue_graduation-cap';
                        break;
                    case 'Tempat Ibadah':
                        var icon = 'green_mosque';
                        break;
                    case 'Sarana Umum':
                        var icon = 'yellow_person-booth';
                        break;
                }
            })
        }
        ...
        function createPoint(){
            ...
            var icon = 'blue_circle'
            $("#createCat").on('change', selectCategory())
        ...
        function editPoint(){
            ...
            var arrayEdit = ["#editName", "#editCat", "#editLat", "#editLng"];
            ...
            var icon = 'blue_circle'
            $("#editCat").on('change', selectCategory())
