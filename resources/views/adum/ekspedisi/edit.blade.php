            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::date('eksped_tanggal', $data->eksped_tanggal, ['class' => 'form-control', 'required' => 'required']) !!}
                    </div>
                    <div class="form-group col-sm-6">
                        {!! Form::label('eksped_tanggal_surat', 'Tanggal Surat') !!}
                        {!! Form::date('eksped_tanggal_surat', $data->eksped_tanggal_surat, ['class' => 'form-control','required' => 'required']) !!}
                    </div>
                    <div class="form-group col-sm-6">
