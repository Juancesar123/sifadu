...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('tanggal_keluar', isset($datasuratkeluar->tanggal_keluar) ? $datasuratkeluar->tanggal_keluar : null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('datasuratkeluars.index') !!}" class="btn btn-default">Batalkan</a>
</div>
@section('scripts')
<script>
